...
public class ParkingInfoPageBackup extends JFrame {
   final static int MAX_CAPACITY = 1000;
    ...
    public   ParkingInfoPageBackup ()
    {
     ...
     public void createAndShowGUI() {
      ...
      //getContentPane().setComponentOrientation(ComponentOrientation.UNKNOWN);
    ...
    //  int  r = 4-  String.valueOf(maxcapacityofparkinglot).length() ;
    //  int  q = 4-String.valueOf(numberOfCars).length()  ;
      String d = "";
    ...
    //  d = d + " ";
      ...
      String s = d + Integer.toString(numberOfCars) + "/" + Integer.toString(maxcapacityofparkinglot);
